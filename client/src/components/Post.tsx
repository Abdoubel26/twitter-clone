...
function Post() {
  return (
    <div className='w-[50%] h-screen bg-linear-to-l from-gray-950 to-gray-900'>
      ...
      <input placeholder='Paste Post Image URL' type='URL' className='bg-black placeholder:text-gray-500 resize-none border border-gray-700 rounded-2xl p-4 w-100 outline-none text-white font-medium my-4'  required></input>
