...
function SideBar() {
  ...
  return (
    <div className="flex flex-col pr-2 pt-2 gap-4 min-h-screen scroll-m-0 w-40 items-end overflow-hidden bg-black border-r-5 border-r-gray-700">
        ...
        <NavLink to='/ai' className={({ isActive }) => isActive ? activeClasses + baseClasses : baseClasses}><div ><AiIcon /></div></NavLink>
        <div className="hover:bg-gray-900 rounded-full p-2"><ThreeDots /></div>
